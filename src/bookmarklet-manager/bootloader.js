...
if (!window.location.href.startsWith("https://google.com/bookmarlet.manager")) {
  console.error(
    "bookmarklet manager: unvalid URL, redirecting to https://google.com/bookmarlet.manager aka base url"
  );
  alert(
    "This bookmarklet is designed to be used on https://google.com/bookmarlet.manager for page reasons. you will be redirected now. rerun this script after the redirect."
  );
